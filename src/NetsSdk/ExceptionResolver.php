<?php
    ...
    /**
     * Tries to figure out what exception occured, and throws a proper exception that
     * can be handled. Exceptions has been implemented based on the documentation (which might change)
    ...
    class ExceptionResolver {
        ...
        public function __construct($rawXmlStringFromApi){
            ...
            $msg = $error->getElementsByTagName('Message')->item(0)->nodeValue; // Message
        ...
        /**
         * Handles the various BBSExceptions and tries to serve as much details as possible.
         * Exceptions and responses are based of the documentation (which might change)
